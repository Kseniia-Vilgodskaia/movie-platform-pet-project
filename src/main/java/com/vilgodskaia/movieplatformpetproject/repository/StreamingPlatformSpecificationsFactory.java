...
import com.vilgodskaia.movieplatformpetproject.model.StreamingPlatform_;
    ...
    public static Specification<StreamingPlatform> filter(StreamingPlatformFilter filter) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (StringUtils.isNotBlank(filter.getSearchString())) {
                predicates.add(likeIgnoreCase(criteriaBuilder, root, StreamingPlatform_.NAME, filter.getSearchString()));
            }
